...
Returns:
    The bucket number in this iteration.
      ...
      .def(
          "get_local_threshold",
          &::c10d::GradBucket::getLocalThreshold,
          py::call_guard<py::gil_scoped_release>(),
          R"(
Returns:
    The local threshold in last iteration.
)")
      .def(
          "get_global_threshold",
          &::c10d::GradBucket::getGlobalThreshold,
          py::call_guard<py::gil_scoped_release>(),
          R"(
Returns:
    The global threshold in last iteration.
)")
      .def(
          "set_tensor",
